...
<div class="container-fluid px-4 py-3">
    <!-- Header -->
    <div class="mb-4">
        <h2 class="mb-1">Edit Data Ternak</h2>
        <p class="text-muted">Perbarui informasi ternak <strong>{{ $ternak->kode_ternak }}</strong></p>
    </div>
...
<form id="form-hapus" action="{{ route('ternak.destroy', $ternak->ternak_id) }}" method="POST" class="d-none">
    @csrf
    @method('DELETE')
</form>
@endsection